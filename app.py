...
<style>
    ...
    .stTabs [data-baseweb="tab"] { color: #666; font-weight: 500; border-radius: 8px; }
    .stTabs [aria-selected="true"] { background-color: #4A90D9; color: white !important; }
    div[data-testid="metric-container"] {
        background-color: #FFFFFF; border-radius: 12px;
        padding: 1rem 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.06);
        border-left: 4px solid #4A90D9;
    }
    h1 { color: #1A1A2E; font-weight: 700; }
    h2 { color: #2C3E50; font-weight: 600; }
    h3 { color: #34495E; font-weight: 600; }
    .stAlert { background-color: #EBF4FF; border: 1px solid #4A90D9;
